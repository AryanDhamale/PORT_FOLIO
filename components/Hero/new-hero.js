...
function Hero()
{
  return (
    ...
    <div className="w-full md:mt-5 md:w-[95%] md:drop-shadow-lg md:rounded-3xl mx-auto  min-h-[80vh] dark:bg-slate-800/50 dark:border-1 bg-[#a4fcac] flex justify-center items-center"> 
