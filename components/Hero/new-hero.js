...
function Hero() {
  ...
  return (
    ...
    <motion.section id="home" initial={{ y: 40, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'spring', duration: 0.8 }}>
      ...
      <div className="relative w-full  md:drop-shadow-lg min-h-[80vh] bg-gradient-to-br from-[#d4eaf7] to-[#f9f9f9] flex justify-center items-center">
       ...
       <div className="w-40 h-40 min-[500px]:w-60 min-[500px]:h-60 rounded-full bg-[#acdbed]/30 bg-surface-alpha backdrop-blur-xl absolute bottom-10 right-15"></div>
        ...
        <div className="z-[10] w-[90%] flex flex-col gap-y-10">
          <h1 className="text-3xl/10 md:text-6xl/20 leading-snug font-medium bg-gradient-to-br bg-[linear-gradient(135deg,_#0090f7,_#ba62fc,_#f2416b,_#f55600)] bg-clip-text text-transparent">
          ...
          <h2 className="text-[#1d1d1f] text-xl md:text-3xl opacity-80 font-light">Full-stack developer. UI enthusiast. Builder of modern web apps using React, Next.js & Node. Currently geeking out over real-time features & CI/CD workflows.</h2>
