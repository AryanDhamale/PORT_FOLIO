...
function Hero()
{
  return (
    ...
    <div className="w-full mt-5  md:drop-shadow-lg min-h-[80vh] shadow-[0_0_12px_#3A86FF33] flex justify-center items-center"> 
        <div className="w-[90%] flex flex-col gap-y-10">
          <h1 className="text-3xl/10 md:text-6xl/20 font-medium bg-gradient-to-br from-[#4361ee] to-[#7209b7]  bg-clip-text text-transparent">
